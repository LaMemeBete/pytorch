...
np.random.seed(123)
paths_subset = np.random.choice(paths, 25, replace=False) # choosing 1000 images randomly
rand_idxs = np.random.permutation(25)
...
# %%
def train_model(model, train_dl, epochs, display_every=2):
